...
public interface BoardDao {
   ...
   public void insert(BoardDto board);//글쓰기(파일 업로드까지)
   //조회수증가, 조회수 증가된 데이터 레코드 찾기
   public BoardDto selectBoard(Integer seq);//(int seq)->글상세보기
   public void updateHit(Integer seq);//조회수 증가
   
   public void update(BoardDto board);//글수정하기
