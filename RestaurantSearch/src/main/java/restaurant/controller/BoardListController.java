	...
	public ModelAndView process
	   (@RequestParam(value="pageNum",defaultValue="1") int currentPage,
		...
		if(log.isDebugEnabled()){
			System.out.println("BoardListController의  boardList.do");
		...
		PagingUtil page = new PagingUtil(currentPage, count, 4,1, "boardList.do");
		...
		mav.setViewName("boardListView");//boardList.jsp로 페이지 이동
