...
import restaurant.board.validator.BoardDeleteValidator;

//유효성검사->입력->ok->boardWriter.jsp화면에 출력
//@키워드->어노테이션, 다른 언어(장식자)라고 부름
...
public class BoardDeleteController {
	...
	//암호가 틀리면 전에 입력한 암호값을 제거 하고 다시 처음부터 값을 입력
	...
	public String form(){
		return "boardDeleteView";//boardDelete.jsp로 이동
	}
	...
	public String submit(@ModelAttribute("command") BoardDto command,BindingResult result){
		...
		BoardDto board=boardDao.selectBoard(command.getSeq());
		//DB상의 암호!=웹상의 암호
