...
<style type="text/css">
	...
	.line{border-bottom:1px solid #F79F81;}
	</style>
<script>
		...
		<div id="wrapper">
			...
			<div id="blog">
				...
				<section class="container">
							...
							<!-- BoardList -->
<table class="tblList" width="100%" border="0" cellspacing="0" cellpadding="2">
	...
	<c:forEach var="article"  items="${list}">
		<tr>
			...
			<td><a href="boardDetail.do?seq=${article.seq }">${article.title}</a></td>
...
<div align="right">
<a href="boardWrite.do"><button class="btn btn-primary">글쓰기</button></a>
</div>
<!-- BoardList -->
<form action="boardList.do" name="search" method="get" onsubmit="return searchCheck()">
	<table align="center" width="500" border="0" cellspacing="0" cellpagging="2">
		<tr>
			<td align="center">
